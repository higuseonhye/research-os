...
| [`paper003_overleaf_v1.0.zip`](paper003_overleaf_v1.0.zip) | **Upload this to Overleaf.** `.tex` + `.bib` + `figures/`, compiles as-is. Set `\draftnotefalse` and verify the bibliography before submission |
