...
Venue-neutral review manuscript v1.1 \\Frozen design: \texttt{\detokenize{paper002-model-order-confirmatory-v1.0}} \\Confirmatory artifact: \texttt{\detokenize{73a7e16}} \\Results are frozen. Version 1.1 updates exposition, positioning, bibliography, \\mathematical typesetting, and submission metadata; it does not change the \\preregistered design or confirmatory results.
